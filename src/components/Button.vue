...
const buttonStyles = computed(() => {
  ...
  // Only apply border radius override if needed
  if (props.rounded === 'full') {
    styles.borderRadius = '9999px'
  } else if (props.rounded === 'none') {
    styles.borderRadius = '0'
  }
  // The btn class in tailwind.css already handles the default border radius
...
const buttonClasses = computed(() => {
  ...
  // Variant styles - use the CSS classes from tailwind.css
