  ...
  <div>
    ...
    <Teleport to="body">
      <Transition name="menu">
        <div v-if="isOpen" class="fixed inset-0 z-[99999] overflow-hidden mobile-menu-overlay">
              ...
              <Transition name="slide-left" appear>
                ...
                >
                  ...
                  >
                    <!-- Header -->
                    <div
                      class="flex items-center justify-between px-4 py-6 border-b"
                    >
                            ...
                            <div v-if="item.links && item.links.length">
                              ...
                              >
                                ...
                                <svg
                                  ...
                                  :class="{
                                    'rotate-180': expandedMenus.includes(
                                      item.title
                                    ),
                                  }"
                                  fill="none"
                              ...
                              <Transition name="submenu">
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <div
                                      v-if="child.links && child.links.length"
                                    >
                                      <button
                                        @click="
                                          toggleSubmenu(
...
const customerUrl = computed(() => {
  return props.customerUrl || window.mobileMenuCustomerUrl || "/user/signIn";
});
