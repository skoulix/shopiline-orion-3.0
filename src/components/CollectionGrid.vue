        ...
        <div v-if="!loading && filteredProducts.length > 0" class="mt-8">
          ...
          <div v-if="enableInfiniteScroll" ref="loadMoreTrigger" class="text-center py-4">
            <div v-if="loadingMore" class="inline-flex items-center">
              <svg class="animate-spin h-5 w-5 text-black mr-2" fill="none" viewBox="0 0 24 24">
                ...
                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                  ...
                  <button
                    ...
                    :class="[
                      ...
                      currentPage === page
                        ? 'z-10 bg-gray-50 border-black text-black'
    ...
    <Teleport to="body">
      ...
      >
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
          <!-- Overlay -->
          <div class="fixed inset-0 bg-black/60 transition-opacity duration-300 overlay-close-cursor" @click="closeQuickView"></div>
