    ...
    <Transition name="drawer">
      <div v-if="isOpen" class="fixed inset-0 z-[99999] overflow-hidden">
        <div class="absolute inset-0 overflow-hidden">
          ...
          <div
            class="fixed inset-y-0 right-0 max-w-full flex pointer-events-none"
          >
                  ...
                  <div class="flex-1 overflow-y-auto">
                    ...
                    >
                      ...
                      >
                        ...
                        Start shopping to find your perfect items!
                      </p>
                      <Button
                        :href="'/collections'"
                        variant="primary"
                    ...
                    >
                      ...
                      <div v-else class="flex items-center gap-2">
                        ...
                        <p class="text-sm text-blue-800">
                          Add
                          {{ formatMoney(freeShippingThreshold - totalPrice) }}
