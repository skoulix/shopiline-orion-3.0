                      ...
                      <div class="flex-1 relative group">
                        ...
                        >
                          <div v-if="loading" class="relative">
                            ...
                            ></div>
                            <div
                              class="animate-spin rounded-full h-5 w-5 border-2 border-gray-400 border-t-transparent absolute inset-0"
                            ></div>
                          </div>
                          <button
                        ...
                        >
                          ...
                          >
                            ...
                            <div class="flex-1 min-w-0">
                              <p
                                class="text-base font-medium text-gray-900 group-hover:text-gray-700 transition-colors line-clamp-2"
                              >
                                {{ product.title }}
                              </p>
...
const formatMoney = (price) => {
  ...
  let moneyFormat = currencyData.format || Shopline?.shop?.money_format || "${{amount}}";
  ...
  try {
    ...
    if (contentType && contentType.includes('application/json')) {
      ...
      productElements.forEach(el => {
        const rawPrice = el.getAttribute('price') || '0';
        const rawComparePrice = el.getAttribute('compare-at-price') || '0';
        ...
        const productData = {
          ...
          price: parseFloat(rawPrice) / 100,  // Convert cents to dollars
          compareAtPrice: parseFloat(rawComparePrice) / 100,  // Convert cents to dollars
    ...
    const formattedProducts = products.map(product => ({
      ...
      price: product.price,  // Already converted from cents to dollars if from HTML parsing
      compareAtPrice: product.compare_at_price || product.compareAtPrice,  // Already converted
